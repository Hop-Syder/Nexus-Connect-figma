...
const STATS = [
  { label: 'Talents connectés', value: '0' },
  { label: 'Profils certifiés', value: '0' },
...
export function HeroSection({ heroImage }: HeroSectionProps) {
  ...
  const displayImage = heroImage?.trim() ? heroImage : '/image/acceuil-nexusconnect-1.jpg';
  ...
  return (
    <section
      ref={ref}
      id="accueil"
      className="relative min-h-[100vh] overflow-hidden bg-gradient-to-br from-[#03133c] via-[#03133c]/95 to-[#010a1c] text-white"
    >
      <div className="absolute inset-0">
        <img
          ...
          loading="lazy"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#010a1c]/85 via-[#021b3a]/70 to-transparent" />
      </div>

      <motion.div
        className="relative mx-auto flex max-w-6xl flex-col gap-16 px-6 py-28 md:flex-row md:items-center"
        style={{ opacity, scale }}
      >
        <div className="flex w-full flex-col space-y-6 md:w-3/5">
          <div className="inline-flex w-full max-w-md items-center gap-2 rounded-full border border-white/10 bg-[#ffd700]/20 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-[#ffd700]">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button
              variant="outline"
              className="rounded-full border-white/50 bg-white/10 px-8 py-4 text-base text-white transition hover:bg-white/20"
            >
        ...
        <div className="flex w-full items-center justify-center md:w-2/5 md:justify-end">
          <div className="relative w-full max-w-sm rounded-[40px] border border-white/20 bg-white/5 p-5 backdrop-blur-xl">
            <div className="relative h-72 overflow-hidden rounded-[36px]">
              <ImageWithFallback src={displayImage} alt="Écosystème Nexus Connect" className="h-full w-full object-cover" />
